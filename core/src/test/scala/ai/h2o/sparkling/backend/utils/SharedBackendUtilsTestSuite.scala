...
class SharedBackendUtilsTestSuite extends AnyFunSuite with Matchers with SharedBackendUtils {
  ...
  private val expectedHttpHeaderArgs = Seq(
    ...
    "-add_http_header",
    "X-Csrf-Token",
    "i8XNjC4b8KVok4uw5RftR38Wgp2BFwq",
    "-add_http_header",
    "X-Forwarded-For",
    "129.78.138.66, 129.78.64.103",
    "-add_http_header",
    "Content-Security-Policy-Report-Only",
    "default-src 'none'; style-src cdn.example.com:8080; report-uri /_/csp-reports")
