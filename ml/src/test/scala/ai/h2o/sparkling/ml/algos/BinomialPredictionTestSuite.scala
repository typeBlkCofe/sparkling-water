...
import ai.h2o.sparkling.ml.metrics.{H2OBinomialGLMMetrics, H2OBinomialMetrics, H2OMetrics, MetricsAssertions}
...
class BinomialPredictionTestSuite extends AnyFunSuite with Matchers with SharedH2OTestContext {
